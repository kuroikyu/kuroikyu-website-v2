const Paw = ({ size = 24 }: { size?: number }) => (
  ...
  >
    ...
    ></path>
    <ellipse cx='72' cy='216' fill='currentColor' rx='56' ry='72'></ellipse>
    <ellipse cx='184' cy='120' fill='currentColor' rx='56' ry='72'></ellipse>
    <ellipse cx='328' cy='120' fill='currentColor' rx='56' ry='72'></ellipse>
    <ellipse cx='440' cy='216' fill='currentColor' rx='56' ry='72'></ellipse>
  </svg>
)
